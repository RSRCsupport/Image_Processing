### The first steps are summarized in the following flowchart:
...
```
ME QUEDE POR AQUI AHORA ES PA ABRIR EL NOTEBOOK...PODRIA HACER ALGO ASI COMO NEX TO RUN THE CODE IN THE NOTEBOOK 
